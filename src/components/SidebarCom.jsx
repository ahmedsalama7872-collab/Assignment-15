...
import { Bookmark, Earth, Newspaper, Sparkles } from "lucide-react";
  export default function SidebarCom() {
    return (
      <Sidebar aria-label="Sidebar with multi-level dropdown example" className="w-60 [&>div]:rounded-2xl [&>div]:border [&>div]:border-slate-200 [&>div]:bg-white [&>div]:p-3 [&>div]:shadow-sm hidden h-fit xl:sticky mt-3 xl:block">
